function fout = BFieldNoise_ONEPHASE( dur_dark, noisex, noisey, noisez, magx, magy, magz, zpol, B0fac, g, randseed )
  ...
  filename = sprintf('Simulations/noiseallsim_dark-%d_x-%d_y-%d_z-%d_magx-%d_magy-%d_magz-%d_zpol-%d_B0fac-%d_g-%d_sol.txt', dur_dark, noisex, noisey, noisez, magx, magy, magz, zpol, B0fac, g )
