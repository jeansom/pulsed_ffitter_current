...
def fitPhases( times, phi1_arr, phi1_err, phi2_arr, phi2_err, absSigma ):
    ...
    phi1_fit, phi1_fit_err = curve_fit( lambda x, a, b: a*x+b, times, phi1_arr, phi1_err, [phi1_fit[0], phi1_fit[1]], [] ) #bounds=([.5*phi1_fit[0], .5*phi1_fit[1]], [1.5*phi1_fit[0], 1.5*phi1_fit[1]]) )
    
    phi2_fit = linregress( times, phi2_arr )
    
    phi2_fit, phi2_fit_err = curve_fit( lambda x, a, b: a*x+b, times, phi2_arr, phi2_err, [phi2_fit[0], phi2_fit[1]], [] ) #bounds=([.5*phi2_fit[0], .5*phi2_fit[1]], [1.5*phi2_fit[0], 1.5*phi2_fit[1]]) )
